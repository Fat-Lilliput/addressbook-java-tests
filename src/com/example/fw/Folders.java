...
public class Folders {
	...
	public Object withAdded(String folder) {
		Folders updatedFolderList = new Folders (storedFolders);
		updatedFolderList.storedFolders.add(folder);
	...
	public Object without(int index) {
		Folders updatedFolderList = new Folders (storedFolders);
		updatedFolderList.storedFolders.remove(index);
		return updatedFolderList;
	}
